...
public abstract class Aplicant {
    ...
    public String afisareRaspunsProiect(Proiect proiect) {

        boolean esteAceptat = punctaj >= proiect.getPragAcceptare();
        StringBuilder stringBuilder = new StringBuilder("Aplicantul: ").append(nume).append(" ").append(prenume).append(" ");
        stringBuilder.append(esteAceptat ? "a fost acceptat" : "a fost respins");
    ...
    public void  setDenumiriProiecte(String[] denumiriProiecte, int numarProiecte){
        this.nr_proiecte = nr_proiecte;
    ...
    public abstract float  getSumaFinanatare();
}
